...
MuseScore {
        ...
        for (var i = 0; i < lines.length; i++) {
            if (lines[i][0] == '{') {
                try {
                    ...
                    for (var j = 0; j < ddAccidentals.length; j++) {
                        if (obj.name == ddAccidentals[j].name) {
                            ddAccidentals[j].tuning = obj.tuning;
                            break;
                        }
                    }
    ...
    function getAccidentalTuning(accidental) {
        ...
        for (var i = 0; i < ddAccidentals.length; i++) {
            if (accidental == ddAccidentals[i].name) {
                return ddAccidentals[i].tuning;
            }
        }
